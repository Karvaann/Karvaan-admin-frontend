...
const Teams = () => {
    ...
    const teamData = [
        { employeeId: "T001", name: "Team A", tier: "Tier 1", owner: "Alice", notes: "Top performing team" },
        { employeeId: "T002", name: "Team B", tier: "Tier 1", owner: "Bob", notes: "Consistent performer" },
        { employeeId: "T003", name: "Team C", tier: "Tier 1", owner: "Charlie", notes: "Newly formed team" }
    ];

    const columns = ["Employee ID", "Team Name", "Tier", "Owner", "Notes", "Action"];

    const data = teamData.map(row => [
