...
const Vendors = () => {
    ...
    const vendorData = [
        { vendorId: "V001", name: "Vendor A", tier: "Tier 1", owner: "Alice", notes: "Top performer" },
        { vendorId: "V002", name: "Vendor B", tier: "Tier 1", owner: "Bob", notes: "Reliable" },
        { vendorId: "V003", name: "Vendor C", tier: "Tier 1", owner: "Charlie", notes: "Newcomer" }
    ];

    const columns = ["Vendor ID", "Name", "Tier", "Owner", "Notes", "Action"];

    const data = vendorData.map(row => [
            <td className="px-4 py-3">{row.vendorId}</td>,
